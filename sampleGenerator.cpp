...
{
    ofstream inputFile("caseIn-100000.txt"); // output into the input.txt 
    ofstream outputFile("caseOut-100000.txt"); // output into the output.txt
    const string OPTIONS[3] = {"search", "insert", "delete"};
    //const string OPTIONS[3] = {"insert", "insert", "insert"};
    unsigned int seed = 114514;
    unsigned int numOperations = 5000; 
